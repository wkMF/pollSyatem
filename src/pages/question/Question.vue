<template>
	<div class="questionB">
        ...
        <div class="btn">
            <el-button type="success" plain  @click='toAddQuestionnaire'>添加</el-button>
            <el-button type="danger" plain @click='batchDeleteQuestionnaires'>批量删除</el-button>
        </div>
		<!-- 按钮结束 -->
		<!-- 表格 -->
		<div v-loading='loading'>
			<el-table :border='true'  :data="questionnaires" style="width: 100%" @selection-change="handleSelectionChange">
	      ...
	      <el-table-column label="操作" width='120' fixed="right" align='center'>
	      	<template slot-scope='{row}'>
	      		<i class="fa fa-eye" title='预览' @click="ylquestion(row.id)"></i>
